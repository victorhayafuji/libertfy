...
import iconRestaurante from '../../assets/kimura.jpg'
...
export default function Restaurante() {
  ...
  const handleEditarComentario = async (id) => {
    ...
    const response = await api.put(`http://localhost:8080/comentarios/${id}`, editarComentario, {
      headers: {
        Authorization: `Bearer ${token}` // Inclui o token de autenticação no cabeçalho da requisição
      }
    });
    ...
    const updatedComentarios = comentarios.map(comentario => {
      if (comentario.id === id) {
        return { ...comentario, editarComentario };
      ...
      <div className='restauranteContainer'>
        ...
        <div className="content">
          ...
          <div className="faixada_restaurante">
            <div className="left">
              <h1 className='restaurante_titulo'>Kimura Restaurante</h1>
          ...
          <div className="infos_restaurante">
            ...
            <span>Telefone: 11 9975-2217</span>
